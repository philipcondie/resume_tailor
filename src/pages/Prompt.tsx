...
export function Prompt() {
    ...
    return (
        <div className="flex flex-col gap-6 ">
            ...
            <div className="max-w-xxl bg-white rounded-xl border border-gray-200 p-8">
                ...
                <div className="flex flex-wrap gap-3 pt-2 border-t border-gray-100 items-center justify-end">
                    {isSaving && <Spinner />}
                    <button
                        className=" min-w-[125px] px-4 py-1.5 text-xs font-medium border border-gray-300 text-gray-600 bg-white rounded hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                        onClick={onRestore}
                        disabled={isSaving}
                    >
                        Restore Default
